namespace BizTalkComponents.PipelineComponents {
    ...
    [Schema(@"http://BizTalkComponents.PipelineComponents.MLDocument",@"Item")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"Item"})]
    public sealed class ProductionItemType : Microsoft.XLANGs.BaseTypes.SchemaBase {
